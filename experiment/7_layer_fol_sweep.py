"""Analysis script for 7_layer_fol_sweep architecture comparison."""
...
set_theme()
OUT_DIR = Path("fig/7_layer_fol_sweep")
...
df = collate_dfs("remote/7_layer_fol_sweep/set", show_progress=True)
if len(df) == 0:
    raise ValueError("No results found in remote/7_layer_fol_sweep/set")
