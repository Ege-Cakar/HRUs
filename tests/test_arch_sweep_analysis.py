...
def test_select_best_by_family_and_train_max_groups_correctly() -> None:
    final_df = pd.DataFrame(
        [
            ...
            {"run_row_id": 3, "train_max_size": 5.0, "model_family": "mamba1", "ood_metric_avg": 0.7},
            ...
            {"run_row_id": 6, "train_max_size": 10.0, "model_family": "mamba1", "ood_metric_avg": 0.9},
        ]
    )
...
def test_filter_size_df_to_best_keeps_only_best_run_rows() -> None:
    best_df = pd.DataFrame(
        [
            ...
            {"run_row_id": 3, "train_max_size": 5.0, "model_family": "mamba1"},
    ...
    size_df = pd.DataFrame(
        [
            ...
            {"run_row_id": 3, "train_max_size": 5.0, "model_family": "mamba1", "size": 5, "comparison_acc": 0.3},
