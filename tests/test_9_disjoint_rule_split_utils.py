"""Tests for experiment 9 disjoint split utility helpers."""
...
MODULE_PATH = ROOT / "experiment" / "remote" / "9_disjoint_rule_split" / "utils.py"

_SPEC = importlib.util.spec_from_file_location("disjoint_rule_split_utils", MODULE_PATH)
